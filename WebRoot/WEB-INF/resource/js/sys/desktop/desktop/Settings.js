            ...
            store: new Ext.data.TreeStore({
                ...
                root: {
                    ...
                    children:[
                        ...
                        child('../res/js/sys/desktop/desktop/wallpapers/Blue-Sencha.jpg'),
                        child('../res/js/sys/desktop/desktop/wallpapers/Dark-Sencha.jpg'),
                        child('../res/js/sys/desktop/desktop/wallpapers/Wood-Sencha.jpg'),
                        child('../res/js/sys/desktop/desktop/wallpapers/blue.jpg'),
                        child('../res/js/sys/desktop/desktop/wallpapers/desk.jpg'),
                        child('../res/js/sys/desktop/desktop/wallpapers/desktop.jpg'),
                        child('../res/js/sys/desktop/desktop/wallpapers/desktop2.jpg'),
                        child('../res/js/sys/desktop/desktop/wallpapers/sky.jpg')
                    ]
                }
            })
        });
